  ...
  <div className="flex flex-col flex-grow">
    ...
    <div className="mb-2 sm:mb-3 md:mb-4">
      {product?.Promotion === "true" ? (
       ...
       {!product?.perDayPricing ? "Call For Pricing" : <span className="text-lg sm:text-xl md:text-2xl font-bold text-rose-700">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <span className="text-sm sm:text-base md:text-xl font-medium text-gray-700 line-through">
             {!product?.perDayPricing ? "Call For Pricing" : <span>${(Number(product.perDayPricing) || 0).toFixed(2)}</span>}  
            </span>
        ...
        <div className="flex items-end gap-1 sm:gap-2">
          <span className="text-lg sm:text-xl md:text-2xl font-bold text-rose-700">
            {
  !product?.perDayPricing || product?.perDayPricing === "0" 
    ? "Call For Pricing" 
    : (
      <span>
