...
const NavbarWhatsapp = () => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const url = 'https://wa.me/message/M6IDG7XQ3MT5M1';
  ...
  return (
    <div 
      className="fixed bottom-0 mb-4 lg:bottom-28 right-6 z-50 cursor-pointer"
