        ...
        <section className="py-16 px-4 md:px-8 lg:px-12 bg-gradient-to-b from-rose-50 to-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Meet the passionate team behind My Color Events LLC, turning
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-600 text-lg mt-4">
                      Yousuf is the lead planner and designer who brings
                      innovative concepts to life with precision and creativity.
                    </p>
                  </div>
              ...
              <div className="lg:w-1/2 w-full">
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-600 text-lg mt-4">
                      Khadiza brings strategic vision and operational excellence
                      to create seamless, memorable events.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 rounded-full bg-rose-600"></div>
                        <p className="text-gray-700 font-medium">
                          10+ Years of Luxury Event Experience
                        </p>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 rounded-full bg-rose-600"></div>
                        <p className="text-gray-700 font-medium">
                          Operations & Client Relations Specialist
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Talented professionals dedicated to making your event
                extraordinary
              </p>
            </div>
            <TeamMember />
