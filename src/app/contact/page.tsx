...
const Page = () => {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 lg:my-20 my-5">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      1565 Monroe Turnpike, Monroe CT 06468
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                <form onSubmit={handleSubmit}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white transition border rounded border-primary bg-rose-900 hover:bg-opacity-90"
                    >
